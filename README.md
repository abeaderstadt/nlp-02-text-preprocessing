...
git clone https://github.com/abeaderstadt/nlp-02-text-preprocessing
...
1. *Updated input text*
   - I replaced the example text file with text_data_beaderstadt.txt, which contains personal text I wrote to simulate toxicology lab notes.
